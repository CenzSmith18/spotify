...
class CreateAcc:
	...
	def create(self):
		...
		self.data = {
			...
			"password":self.pasw,
			"key":"142b583129b2df829de3656f9eb484e6", "birth_year":"1989",
			"email": randomMail,
		...
		try:
			...
			if self.run["status"] == 1:
				...
				print("Titit Tole Kecil")
				print("Terima Kasih Telah Berbelanja Di LenteraShopIndonesia Jangan Lupa Isi Kesan Pembelian Anda")
			else:
				exit("[×] failed created")
		except:
			exit("[×] failed created")
